...
ALL_COLUMN_NAMES = [GROUP, SOURCE_TYPE, SOURCE_SCHEMA, SOURCE_TABLE,SOURCE_COLUMN,JOIN_TABLE_1,JOINER_COLUMN_1,JOIN_TYPE1,TARGET_TABLE,TRANSFORMATION_RULE,TARGET_COLUMN]
