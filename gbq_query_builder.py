...
def generate_base_queries(file_name,output_file):
    ...
    if not df.empty:
        ...
        grouped = df.groupby([GROUP,SOURCE_PROJECT, SOURCE_SCHEMA, SOURCE_TABLE, JOIN_TABLE_1,JOINER_COLUMN_1,JOIN_TYPE1,TARGET_TABLE])
        """
        print("grouped df:\n")
        ...
        with open(output_file, 'w') as f:
            ...
            for (group, source_project,source_schema, source_table,join_table_1,join_column1,join_type_1 ,target_table), group_df in grouped:
